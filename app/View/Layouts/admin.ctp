                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->Html->image('admin/avatar3.png', array('class' => 'img-circle', 'alt' => 'User Image'));?>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->Html->image('admin/avatar2.png', array('class' => 'img-circle', 'alt' => 'User Image'));?>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <?php echo $this->Html->image('admin/avatar.png', array('class' => 'img-circle', 'alt' => 'User Image'));?>
                                                </div>
                                                <h4>
                                                    Developers
