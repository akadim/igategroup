...
<div class="newRCbox1">
    ...
    <br>
    <?php echo $this->Form->create('Prospect', array('action' => 'signup'), array('inputDefaults' => array('div' => false))); ?>
    ...
    <div class="control-group form-group">
        <div class="controls">
            <?php echo $this->Form->input('email', array('label' => 'Email', 'type' => 'email', 'class' => 'form-control', 'data-validation-required-message' => 'Le champs \'Email\' est requis', 'required' => 'required')); ?>
        </div>
    </div>
    <div class="control-group form-group">
        <div class="controls">
